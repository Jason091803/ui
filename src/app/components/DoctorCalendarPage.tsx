    ...
    <div className="size-full flex flex-col bg-[#FDFBF7] overflow-auto font-sans text-gray-900 pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-2 py-3 rounded-t-3xl shadow-[0_-5px_20px_-10px_rgba(0,0,0,0.05)] z-50">
        <div className="flex justify-around items-center max-w-md mx-auto relative">
          ...
          <button onClick={onNavigateToActivities} className="flex flex-col items-center gap-1 text-gray-400 hover:text-[color:var(--theme-primary)] transition-colors w-12"><ListChecks className="w-5 h-5" /><span className="text-[10px] font-semibold">Activities</span></button>
